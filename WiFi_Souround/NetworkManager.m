...
static NetworkManager *NetworksManager;

@implementation NetworkManager
+ (NetworkManager *)sharedNetworksManager
{
    if (!NetworksManager)
        NetworksManager = [[NetworkManager alloc] init];
...
//    [types retain];
    ...
    libHandle = dlopen("/System/Library/Frameworks/CoreTelephony.framework/CoreTelephony"/*/System/Library/SystemConfiguration/WiFiManager.bundle/WiFiManager"*/, RTLD_LAZY);
